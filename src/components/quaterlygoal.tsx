    ...
    return (
        ...
        >
            <div className="w-[12.5rem] h-16 bg-[#D3D3D3] rounded-[10px] p-[5px] relative">
                ...
                <div className="flex">
                    <textarea name="" id="" placeholder="Descrição do Objetivo Trimestral" spellCheck={false} className="bg-transparent outline-none text-[0.625rem] resize-none m-auto text-center overflow-auto flex justify-center items-center mt-2 max-h-10 placeholder:text-[0.625rem]"></textarea>
                </div>
