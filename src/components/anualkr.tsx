                    ...
                    <div className="flex items-center gap-[4.813rem]">
                        ...
                        <div className="flex gap-[0.25rem] items-center">
                            <div className="bg-white  size-3 rounded-[4px] flex content-center items-center justify-center ">
                                {
                                    shouldShowRS ? (
                                        <button onClick={handleRsChanged} className="outline-none"><img src={rsinfokr} alt="" className="w-[0.5rem] h-[0.375rem] outline-none"/></button>
                                    ):(
                                        <button onClick={handleRsChanged} className="outline-none"><img src={porceinfokr} alt="" className="w-[0.5rem] h-[0.375rem] outline-none"/></button>
                                    )
                                }
